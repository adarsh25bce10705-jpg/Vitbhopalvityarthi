...
3. (Optional) Install `python-docx` if you want to generate Word documents:
4. Place the project files in a folder. At minimum you should have:
...
`
Follow the prompts to add, issue, return, or display books.

Example: Display books
1. Choose `2` at the menu prompt.
2. The program prints all books and their status:
```
